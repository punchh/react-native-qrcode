...
var QRCode = createReactClass({
    ...
    // The problem originates from the QRCode library.
    //If we change the canvas -> context -> size to size * 4 it will always cover the whole white space and will fit / dynamically change whenever we pass another size.
    render: function () {
